...
[![GoDoc](https://godoc.org/github.com/gredinger/graw?status.svg)](https://godoc.org/github.com/gredinger/graw)

    go get github.com/gredinger/graw
...
[api handle from the reddit package](https://godoc.org/github.com/gredinger/graw/reddit)
and a tell it what events you want to subscribe to; graw will take care of the
rest. See the [godoc](https://godoc.org/github.com/gredinger/graw) and
